...
cd ~/deploy_limonaid.opens.science
...
rm -rf ~/limonaid.opens.science/*.*
rm -rf ~/limonaid.opens.science/*
rm -f ~/limonaid.opens.science/.htaccess

### Copy website
cp -RT public ~/limonaid.opens.science

### Copy .htaccess
#cp -f .htaccess ~/limonaid.opens.science

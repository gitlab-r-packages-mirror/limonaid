...
userfriendly import of responses from LimeSurvey studies. {limonaid} also implements a number of functions to work with the LimeSurvey API from the defunct {limer} package by [Andrew Heiss](https://www.andrewheiss.com).
